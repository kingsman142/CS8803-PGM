...
= \sum_{i=1}^{N} P(y^i \vert x^i, \theta)\log\frac{\frac{P(x^i, y^i \vert \theta)}{P(x^i \vert \theta)}}{\frac{P(x^i, y^i \vert \theta^0)}{P(x^i \vert \theta^0)}} \\
= \sum_{i=1}^{N} P(y^i \vert x^i, \theta)\log\frac{P(x^i, y^i \vert \theta)P(x^i \vert \theta^0)}{P(x^i, y^i \vert \theta^0)P(x^i \vert \theta)} \\
= \sum_{i=1}^{N} P(y^i \vert x^i, \theta^0)\log\frac{P(x^i, y^i \vert \theta^0)P(x^i \vert \theta^0)}{P(x^i, y^i \vert \theta^0)P(x^i \vert \theta^0)} \qquad$ (substitute $\theta = \theta^0$) \\
